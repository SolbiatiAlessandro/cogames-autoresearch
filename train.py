...
REWARD_VARIANTS = ["milestones", "milestones_2:25", "role_conditional", "penalize_vibe_change", "credit"]  # available: objective, milestones, milestones_2, milestones_2:N, credit, miner, aligner, scrambler, scout, role_conditional, penalize_vibe_change
NUM_AGENTS = 4
...
DESCRIPTION = "milestones + milestones_2:25 + role_cond + penalize_vibe + credit ent=0.10 gamma=0.999 gae=0.95 10min — credit bootstrap on best scoring combo"
